...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SmashBrosTest_ECharacterClass_Hash() { return 3170538558U; }
	UEnum* Z_Construct_UEnum_SmashBrosTest_ECharacterClass()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "ECharacterClass::VE_Oscar", (int64)ECharacterClass::VE_Oscar },
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "VE_Default.Comment", "/**\n * \n */" },
				{ "VE_Default.DisplayName", "Balanced" },
				...
				{ "VE_Oscar.Comment", "/**\n * \n */" },
				{ "VE_Oscar.DisplayName", "Oscar" },
				{ "VE_Oscar.Name", "ECharacterClass::VE_Oscar" },
	...
	IMPLEMENT_CLASS(UBaseGameInstance, 571905974);
