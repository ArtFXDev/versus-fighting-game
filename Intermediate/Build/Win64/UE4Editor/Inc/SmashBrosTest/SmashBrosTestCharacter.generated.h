...
#define versus_fighting_game_Source_SmashBrosTest_SmashBrosTestCharacter_h_12_RPC_WRAPPERS \
 ...
 \
	DECLARE_FUNCTION(execP2keyboardMoveRight) \
	{ \
		P_GET_PROPERTY(UFloatProperty,Z_Param__val); \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->P2keyboardMoveRight(Z_Param__val); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execP2keyboardStopJumping) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->P2keyboardStopJumping(); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execP2keyboardJump) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->P2keyboardJump(); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execP2keyboardAttack3) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->P2keyboardAttack3(); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execP2keyboardAttack2) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->P2keyboardAttack2(); \
		P_NATIVE_END; \
	} \
 \
	DECLARE_FUNCTION(execP2keyboardAttack1) \
	{ \
		P_FINISH; \
		P_NATIVE_BEGIN; \
		P_THIS->P2keyboardAttack1(); \
		P_NATIVE_END; \
	}
