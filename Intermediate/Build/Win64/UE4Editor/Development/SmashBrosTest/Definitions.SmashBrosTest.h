#undef SMASHBROSTEST_API
#undef SMASHBROSTEST_VTABLE
...
#define UE_PROJECT_NAME SmashBrosTest
...
#define SMASHBROSTEST_VTABLE DLLEXPORT_VTABLE
#define SMASHBROSTEST_API DLLEXPORT
